...
#define SETTING_A (1<<COM3A1)|(1<<COM3B1)|(1<<COM3C1)|(1<<WGM31)|(1<<WGM30)
#define SETTING_B (1<<WGM32)|(1<<CS31)
//-------------------------------------------------------

//FUNCTION
void init_rgb_led(); // Инициализация RGB-светодиода и таймера
void color_rgb_led(uint16_t red, uint16_t green, uint16_t blue); // Изменение регистра OCR3nH и OCR3nL 
//-------------------------------------------------------
